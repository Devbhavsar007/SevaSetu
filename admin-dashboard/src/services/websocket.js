/**
 * WebSocket Manager — Singleton for real-time event subscriptions.
 * 
 * Usage:
 *   import { wsManager } from '../services/websocket';
 *   wsManager.connect('admin', token, (event) => { ... });
...
class WSManager {
  ...
  _doConnect() {
    ...
    this.ws.onclose = (event) => {
      ...
      // Don't reconnect on intentional close (code 1000) or auth errors (4001, 4002)
